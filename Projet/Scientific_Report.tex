...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Value of $k_{max}$&3&4&\\
		\hline
		Computation time (s)&609.9&1445.9&\\
		\hline
	\end{tabular}
...
\begin{itemize}
	...
	\item It should be possible to optimize our algorithms, at least enough so that the "smart" algorithms are faster than the naive ones.
\end{itemize}
